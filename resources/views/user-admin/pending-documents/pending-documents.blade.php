                ...
                <table id="pendingTable" class="w-full table-fixed">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t-[1px] border-[#1e1e1e]/15 w-full rounded-md">
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->applicationForm->lrn }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->applicationForm->full_name }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->applicationForm->age }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->applicationForm->birthdate }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ \Carbon\Carbon::parse($pending_document->interview->date)->timezone('Asia/Manila')->format('M. d') }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->applicationForm->grade_level }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->interview->status }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_document->interview->status }}</td>

                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate"><a href="/pending-documents/document-details/{{$pending_document->applicationForm->id }}">View</a></td>
