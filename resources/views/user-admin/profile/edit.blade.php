...
@section('content')
    <div class=" {{ auth()->user()->hasRole('applicant') ? 'px-40' : 'p-6' }}">
        ...
        @role('applicant')
        <a href="/admission" class="flex flex-row justify-start items-center text-gray-600 gap-2 text-[18px] mb-8"><i class="fi fi-rr-angle-left flex justify-center items-center text-gray-500 text-[16px]"></i>
            Back
        </a>
        @endrole
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @if ($user->pin_enabled)
                            <div>
                                ...
                                <input type="password" name="pin_verification" maxlength="6"
                                    class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                    ...
                    <form method="POST" action="{{ route('profile.pin.setup') }}" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="password" name="new_pin" maxlength="6"
                                    class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                                    placeholder="Enter new PIN (6 digits)" required>
                                @error('new_pin')
                                    <p class="text-red-600 text-sm mt-1 flex items-center">
                                        <i class="fi fi-rr-exclamation mr-1"></i>
                                        {{ $message }}
                            ...
                            <div>
                                ...
                                <input type="password" name="new_pin_confirmation" maxlength="6"
                                    class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                                    placeholder="Confirm new PIN (6 digits)" required>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-3">
                            <div class="flex items-center">
                                ...
                                <p class="text-green-800 text-sm">
                                    <strong>Setup PIN:</strong> Create a 6-digit PIN for additional security
                                    verification.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            ...
                            <p class="text-yellow-800 text-sm mb-4">
                                Your PIN is set up but currently disabled. You can re-enable it anytime to add an extra
                                layer of security.
                            </p>
                            ...
                            <form method="POST" action="{{ route('profile.pin.enable') }}" class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="password" name="current_pin" id="enable_current_pin" maxlength="6"
                                            class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                ...
                @else
                    ...
                    <div class="space-y-6">
                            ...
                            <form method="POST" action="{{ route('profile.pin.update') }}" class="space-y-4"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="password" name="current_pin" id="update_current_pin" maxlength="6"
                                            class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="new_pin" id="update_new_pin" maxlength="6"
                                            class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="password" name="new_pin_confirmation"
                                            id="update_new_pin_confirmation" maxlength="6"
                                            class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                        ...
                        <div class="border border-red-200 rounded-lg p-4 bg-red-50">
                            ...
                            <form method="POST" action="{{ route('profile.pin.disable') }}" class="space-y-4"
                                id="disable-pin-form">
                                @csrf
                                @method('DELETE')
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="password" name="current_pin" id="disable_current_pin"
                                            maxlength="6"
                                            class="flex flex-row justify-start items-center border-2 border-[#1e1e1e]/10 bg-gray-100 self-start rounded-lg py-2 px-3 gap-2 w-full outline-none hover:ring hover:ring-[#199BCF]/20 focus-within:ring focus-within:ring-[#199BCF]/10 focus-within:border-[#199BCF] transition duration-150 shadow-sm text-[14px]"
                                            placeholder="Enter current PIN to disable" required>
                                        @error('current_pin')
                                            <p class="text-red-600 text-sm mt-1 flex items-center">
                                                <i class="fi fi-rr-exclamation mr-1"></i>
                                                {{ $message }}
                                ...
                                <div class="bg-red-100 border border-red-300 rounded-lg p-3">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-red-800 text-sm">
                                            <strong>Warning:</strong> Disabling your PIN will remove the additional
                                            security
                                            layer. You will no longer need to enter your PIN for password changes.
                                        </p>
                                    </div>
                                </div>

                                <div class="flex flex-row justify-end items-center gap-3 pt-4">
                                    <button type="button" onclick="openDisablePinModal()"
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-4">
                    <div class="flex items-center">
                        ...
                        <p class="text-yellow-800 text-sm">
                            <strong>Security Note:</strong> Your PIN is used for additional security verification. Keep
                            it
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    <p class="text-gray-700 mb-3">
                        Are you sure you want to disable your PIN? This will temporarily disable the additional security
                        layer. You can re-enable it anytime by entering your PIN.
                    </p>
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        <div class="flex items-center">
                            <i class="fi fi-rr-info text-yellow-600 mr-2"></i>
                            <p class="text-yellow-800 text-sm">
                                <strong>Note:</strong> Your PIN will be kept and you can re-enable it later without
                                setting
                                up a new one.
                            </p>
                        </div>
