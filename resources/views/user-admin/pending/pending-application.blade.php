...
@section('content')
    <div class="flex flex-col">
        <div class="text-start border-b border-[#1e1e1e]/10 pl-[14px] py-[10px]">
            <p class="text-[16px] md:text-[16px] font-bold">Pending Applications</p>
        </div>
                ...
                <table id="pendingTable" class="w-full table-fixed">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t-[1px] border-[#1e1e1e]/15 w-full rounded-md">
                            ...
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_applicant->applicationForm->full_name }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_applicant->applicationForm->age }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_applicant->applicationForm->birthdate }}</td>
                            <td class="w-1/8 text-start font-regular py-[8px] text-[14px] opacity-80 px-4 py-2 truncate">{{ $pending_applicant->applicationForm->desired_program }}</td>
