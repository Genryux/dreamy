@extends('layouts.app', ['title' => 'Password Reset Success'])
...
@section('login_page')
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <div
                    class="mx-auto h-16 w-16 flex items-center justify-center rounded-full bg-gradient-to-br from-[#199BCF] to-[#C8A165]">
                    <i class="fi fi-rr-check-circle text-white text-2xl flex justify-center items-center"></i>
                </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm border border-white/20 py-8 px-4 shadow-lg rounded-xl sm:px-10">
                <div class="text-center">
                    <div
                        class="mx-auto h-20 w-20 flex items-center justify-center rounded-full bg-gradient-to-br from-[#199BCF] to-[#C8A165] mb-6">
                        <i class="fi fi-rr-shield-check text-white text-3xl flex justify-center items-center"></i>
                    </div>
                            ...
                            <div class="ml-3">
                                <div class="flex flex-row justify-center items-center gap-2">
                                    <div class="flex-shrink-0">
                                        <i class="fi fi-rr-check-circle text-green-400 flex justify-center items-center"></i>
                                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="text-center">
                            <a href="{{ route('password.request') }}"
                                class="flex justify-center items-center gap-2 text-sm text-gray-300 hover:text-white transition duration-150">
                                <i class="fi fi-rr-refresh mr-1 flex justify-center items-center"></i>
