...
@section('login_page')
    <div class="relative w-full h-full md:h-screen  pb-16">

        <div class="absolute top-10 left-20 text-white hidden md:flex flex-row justify-center items-center"
            data-aos="fade-left" data-aos-duration="1000">
            <a href="/"
                class="hover:-translate-x-4 transition duration-200 flex flex-row justify-center items-center"><i
                    class="fi fi-rr-angle-left text-gray-300 text-[32px] flex flex-row justify-center items-center"></i>Back
                to Homepage</a>
        </div>
            ...
            <div class="h-full w-full flex flex-col justify-center items-center ">
                ...
                <form method="POST" action="/register"
                    ...
                    <div class="flex flex-col justify-center items-start gap-4">
                        ...
                        <h1 class="font-bold text-[22px] md:text-[28px]" data-aos="fade-up" data-aos-duration="800">Sign Up
                        </h1>
                    ...
                    <div class="flex flex-col justify-center items-end space-y-4 w-full mb-16">

                        <div class="border-b border-gray-900/10 w-full space-y-4">

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="sm:col-span-4 md:col-span-1 w-full text-white space-y-4" data-aos="fade-up"
                                    data-aos-duration="900">
                                    <label for="first_name" class="block font-semibold text-[16px] ">First Name</label>
                                    <div class="mt-2 space-y-2">
                                        <div
                                            class="flex items-center rounded-md bg-transparent pl-2 border-2 border-white/60">
                                ...
                                <div class="sm:col-span-4 md:col-span-2 w-full text-white space-y-4" data-aos="fade-up"
                                    data-aos-duration="900">
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <div
                                            ...
                                            <input type="email" name="email" id="email"
                                                ...
                                                autocomplete="email" @error('email') aria-invalid="true" @enderror required>
                                        </div>

                                    </div>
                                </div>

                                <div class="flex flex-col w-full space-y-4 md:col-span-1" data-aos="fade-up"
                                ...
                                <div class="flex flex-col w-full space-y-4 md:col-span-1" data-aos="fade-up"
                                    ...
                                    <label for="password_confirmation"
                                        class="block text-[16px] font-semibold text-white">Confirm Password</label>
                                    <div class="mt-2 space-y-2 w-full ">
                                        <div
                                            class="flex items-center rounded-md bg-transparent pl-2 border-2 border-white/60">
                                ...
                                @if ($errors->any())
                                    <div class="md:col-span-2 w-full" data-aos="fade-up" data-aos-duration="1000">
                                        <div class="mt-2">
                                            <div
                                                class="rounded-md border-2 border-red-400/60 bg-red-900/10 text-red-200 px-3 py-2">
                        ...
                        <div class="flex flex-col justify-center items-center gap-y-6 w-full">
                            <button type="submit"
                                class="rounded-xl bg-[#199BCF] px-3 py-4 md:py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-full shadow-xl"
                                data-aos="fade-up" data-aos-duration="1000">Register</button>
