...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Your account has been successfully created on <strong>{{ config('app.name') }}</strong>. You can now access the system using the credentials below.</p>
            ...
            <p class="info-text">If you have any questions or need assistance, please contact your system administrator.</p>
        </div>
