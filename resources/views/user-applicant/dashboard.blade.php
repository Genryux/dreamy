        ...
        <div class="text-center">
            ...
            @if (!$currentAcadTerm)
                <p class="text-[18px] md:text-[20px] font-semibold p-10">
                    ...
                    <img src="{{ asset('images/Nerd-amico.svg') }}" alt="" class="size-[200px] md:size-[300px] mx-auto mt-4">
                </p>
                </svg>
            ...
            @else
                ...
                @if ($activeEnrollmentPeriod->status === 'Paused')
                    <p class="text-[18px] md:text-[20px] font-bold p-10">
                        Enrollment period is currently closed. At this time, we are not accepting any new applications.
                    </p>
