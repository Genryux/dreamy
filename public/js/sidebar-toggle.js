...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (sideNav) {
        ...
        if (savedState === 'true' && window.innerWidth >= 768) {
            ...
            if (mainContent) {
                // Remove px-10 and set inline padding to 100px with smooth transition
                mainContent.classList.remove('px-10');
                mainContent.style.transition = 'padding 0.3s ease-in-out';
            ...
            toggleButton.addEventListener('click', function () {
                ...
                if (sideNav.classList.contains('collapsed')) {
                    ...
                    setTimeout(() => {
                        ...
                        const mainContent = document.getElementById('main-content');
                        if (mainContent) {
                            // Clear inline styles and restore px-10 with smooth transition
                            mainContent.style.transition = 'padding 0.3s ease-in-out';
